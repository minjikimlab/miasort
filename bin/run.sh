...
python ./mia-sort/main.py --path1 ./data/test_input.region --path2 ./data/test_input_abc.domains \
--type AandBandC --graphs none --numfrag_min 2  \
--anchor_options yes_complete --out_dir ./test_folder_syn_AandBandC_6000
