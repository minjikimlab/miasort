...
#SBATCH --job-name=bedtools_gm_100_line_no_plot
#SBATCH --mail-user=zhangzzc@umich.edu
#SBATCH --mail-type=END,FAIL
#SBATCH --output=./logs/bedtools_gm_100_no_plot.log
...
--out_dir test_greatlakes_bedtools_gm_100_no_plot --graph_flag no
